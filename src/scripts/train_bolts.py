...
from data_parsing.bolts.data_parser import DataParser
...
for model_id in range(20):
    ...
    proto_dist_weights = [0.1, 0.0, 0.0]  # How realistic are the prototypes
    ...
    # disentangle_weight[0] = [0, -10, 100]
    disentangle_weight[0] = [0, -10, 0]
    # kl_losses = [1 for _ in range(num_tasks)]
    # kl_losses = [5, 0, 5]
    ...
    proto_model.train(train_inputs, train_inputs, one_hot_output_train, batch_size=64, epochs=10)
