...
for model_id in range(30):
    ...
    y_accs, s_diff, _, _, disparate_impact, demographic, average_cost = proto_model.evaluate(test_data, test_data, test_outputs, test_outputs_one_hot, plot=False, do_fairness_eval=True)
    y_acc = y_accs[0]
