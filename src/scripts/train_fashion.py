...
from data_parsing.mnist_data import get_fashion_data, make_noisy, get_fashion_tree
from models.proto_model import ProtoModel
from utils.gpu import set_gpu_config
from utils.eval import trees_match, graph_edit_dist
from utils.plotting import plot_mst
...
for model_id in range(10):
    ...
    proto_model.train(x_train_noisy, x_train, one_hot_output, batch_size=64, epochs=0)
